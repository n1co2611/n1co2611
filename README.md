...
![JCL](https://img.shields.io/badge/JCL-005073?style=flat-square&logoColor=white)
...
|---|---|---|---|
| [Noma](https://noma.ovh) | Plataforma para descubrir productos artesanales con mapa interactivo y asistente conversacional. Responsable del chatbot y de la estrategia SEO | Dialogflow · SEO | Publicado |
| [EpicBox](https://github.com/n1co2611/EpicBox) | Marketplace de assets digitales — modelos 3D/2D, scripts y efectos | React · Node.js · MongoDB | Publicado |
| CarGest | App móvil de gestión de flotas de vehículos: ficha, documentación y mantenimientos (TFG) | Ionic · Angular · Firebase | En desarrollo |
